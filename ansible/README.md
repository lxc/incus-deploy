...
## Ceph
 ...
 - `ceph_fsid`: UUID of the Ceph cluster (use `uuidgen` or similar to generate) (type: string)
 ...
 - `ceph_roles`: List of roles the server should have in the Ceph cluster (type: list of string):
