...
OVN_CTL_OPTS="\
    --ovn-controller-ssl-key=/etc/ovn/{{ ovn_name }}.server.key \
    --ovn-controller-ssl-cert=/etc/ovn/{{ ovn_name }}.server.crt \
    --ovn-controller-ssl-ca-cert=/etc/ovn/{{ ovn_name }}.ca.crt"
